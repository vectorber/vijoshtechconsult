# AGENTS.md — TechCore Systems Website

This document provides an overview of the project structure for developers and AI agents working on this codebase.

## Project Overview

A computer sales and IT services business website for TechCore Systems. Built with TanStack Start (React SSR) and deployed on Netlify. The primary sales channel is WhatsApp (pre-filled deep-links); Stripe checkout is optional.
